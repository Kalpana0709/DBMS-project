    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try{
                ...
                System.out.println("d1 changed to dd1 from depot");
                stmt.executeUpdate("UPDATE Stock SET depid = 'dd1' WHERE depid = 'd1';");
                System.out.println("d1 changed to dd1 from stock");
